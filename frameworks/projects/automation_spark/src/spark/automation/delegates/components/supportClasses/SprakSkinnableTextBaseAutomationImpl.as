...
package spark.automation.delegates.components.supportClasses
{
	 ...
	 */
	public class SprakSkinnableTextBaseAutomationImpl extends SparkSkinnableComponentAutomationImpl 
	{
		...
		{
			Automation.registerDelegateClass(spark.components.supportClasses.SkinnableTextBase, SprakSkinnableTextBaseAutomationImpl);
		}   
		 ...
		 *  @productversion Flex 3
		 */
		public function SprakSkinnableTextBaseAutomationImpl(obj:spark.components.supportClasses.SkinnableTextBase)
		{
			super(obj);
